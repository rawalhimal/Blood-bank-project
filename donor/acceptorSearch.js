...
import { Container, Header, Content, Card, CardItem, Body,Button,Right } from "native-base";
import call from "react-native-phone-call";
import Icon from '@expo/vector-icons/Ionicons';
//import { Button } from 'native-base';
//import all the components we are going to use.
 
export default class AcceptorSearch extends Component {
  ...
  render() {
    ...
    return (
      ...
      <View style={styles.viewStyle}>
        ...
        />
        <Text></Text>
         <Button block light onPress={()=>this.props.navigation.navigate('bloodbank')}>
          <Text> Blood Bank Detail</Text>
        </Button>
